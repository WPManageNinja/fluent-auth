    ...
    public function render()
    {
        ...
        wp_localize_script('fluent_auth_app', 'fluentAuthAdmin', [
            ...
            'i18n'          => [
                ...
                'login_ip_try_limit'            => __('Login Try Limit per IP address in certain defined', 'fluent-security'),
                'login_try_time_limit'          => __('Time limit for login try in', 'fluent-security'),
                'user_fails_to_login'           => __('If a user fails to log in', 'fluent-security'),
                'times_within'                  => __('times within', 'fluent-security'),
                ...
                'enable_2fa_via_email'          => __('Enable Two-Factor Authentication via Email', 'fluent-security'),
                'select_roles_for_2fa'          => __('Select Roles that requires Two-Factor Authentication', 'fluent-security'),
                'enabled_for_all_user_roles'    => __('Enabled for all user roles', 'fluent-security'),
